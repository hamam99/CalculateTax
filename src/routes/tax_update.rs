...
use actix_web::{HttpResponse, Responder, patch, post, web};
...
async fn tax_update(
    ...
    let query = format!(
        "UPDATE TAX SET name = '{}', salary_per_month = {}, is_already_married = {}, number_of_children = {}, salary_taxed = {}, tax_to_pay = {} WHERE id = {}",
        name,
        item.salary_per_month,
        is_already_married,
        item.number_of_children,
